...
pub mod actions {
    ...
    impl ActionsImpl of IAction<ContractState> {
        ...
        fn join_pool(ref self: ContractState, option: u8, amount: u256) {
            ...
            // assert(maybe_player.stake_amount == 0, 'Player already joined this pool');
        ...
        fn get_pool_player(
            ...
            let world = self.world_default();
            let player: PoolPlayer = world.read_model((game_id, player));
            player
        }
        ...
        fn get_claimable_reward(self: @ContractState, game_id: u64, user: ContractAddress) -> u256 {
            ...
            // let reward = player.stake_amount * game.payout_rate;
            // reward
            0
        }
    }
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn get_distributable_pool_amount(self: @ContractState, game_id: u64) -> u256 {
            let world = self.world_default();
            let game: Game = world.read_model(game_id);
            let distributable_amount = game.total_stake_amount * PROTOCOL_FEE / 100_u256;
        ...
        fn calculate_odds(self: @ContractState, game_id: u64, option: u8) -> u256 {
            ...
            let odds = if option == 0_u8 {
                game.total_heads_stake / distributable_pool_amount
            } else {
                game.total_tails_stake / distributable_pool_amount
            };
            odds
        }
